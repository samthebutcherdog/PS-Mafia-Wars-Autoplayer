...
if (!initialized) {
  ...
  var requirementJob = new Array(
    // Item, Job, Level
    ['Liquor', 'Distill Some Liquor',1],
    ['Tokens', 'Manufacture Tokens',1],
    ['Wiretap Device', 'Overtake Phone Central',1],
    ['1 Wiretap Device', 'Overtake Phone Central',1],
    ['Cards', 'Get Cheating Deck',1],
    ['Untraceable Cell Phone', 'Rob an Electronics Store',1],
    ['Concealable Camera', 'Rob an Electronics Store',1],
    ['Computer Set-Up', 'Rob an Electronics Store',1],
    ['Blackmail Photos', 'Obtain Compromising Photos',1],
    ['Illegal Transaction Records', 'Steal Bank Records',1],
    ['.22 Pistol', 'Beat Up Rival Gangster',1],
    ['Revolver', 'Beat Up Rival Gangster',1],
    ['9mm Semi-Automatic', 'Rob a Pimp',1],
    ['Butterfly Knife', 'Collect Protection Money',1],
    ['Brass Knuckles', 'Rough Up Dealers',1],
    ['Tactical Shotgun', 'Perform a Hit',1],
    ['.45 Revolver', 'Take Out a Rogue Cop',1],
    ['C4', 'Destroy Enemy Mob Hideout',1],
    ['Stab-Proof Vest', 'Kill a Protected Snitch',1],
    ['Automatic Rifle', 'Bust a Made Man Out of Prison',1],
    ['Lucky Shamrock Medallion', 'Clip the Irish Mob\'s Local Enforcer',1],
    ['Semi-Automatic Shotgun', 'Fight a Haitian Gang',1],
    ['Firebomb', 'Steal a Tanker Truck',1],
    ['Armored Truck', 'Smuggle Across the Border',1],
    ['Grenade Launcher', 'Repel the Yakuza',1],
    ['.50 Caliber Rifle', 'Disrupt Rival Smuggling Ring',1],
    ['Armored Car', 'Invade Tong-controlled Neighborhood',1],
    ['RPG Launcher', 'Sell Guns to the Russian Mob',1],
    ['Bodyguards', 'Protect your City against a Rival Family',1],
    ['Night Vision Goggles', 'Assassinate a Political Figure',1],
    ['Napalm', 'Exterminate a Rival Family',1],
    ['Prop plane', 'Steal an Air Freight Delivery',1],
    ['Chopper', 'Run a Biker Gang Out of Town',1],
    ['Luxury Yacht', 'Influence a Harbor Official',1],
    ['GX9', 'Ransom a Businessman\'s Kids',1],
    ['Bookie\'s Holdout Pistol', 'Fix the Big Game',1],
    ['Multi-Purpose Truck', 'Break Into the Armory',1],
    ['BA-12 Assault Rifle', 'Rip Off the Armenian Mob',1],
    ['Falsified Documents', 'Take Over an Identity Theft Ring',1],
    ['Federal Agent', 'Buy Off a Federal Agent',1],
    ['Private Jet', 'Make a Deal with the Mexican Cartel',1],
    ['Police Cruiser', 'Blackmail the District Attorney',1],
    ['Armoured Limousine', 'Shake Down a City Council Member',1],
    ['Cigarette Boat', 'Take Over The Docks',35],
    ['TNT', 'Raid The Arms Depot',35],
    ['Si-14 Cargo Plane', 'Capture The Airport',35],
    ['Armored State Car', 'Storm The Presidential Palace',35],
    ['Untraceable Cell Phone', 'Arrange A Drug Shipment for the Mafiya',70],
    ['Concealable Camera', 'Smuggle Consumer Electronics for the Vory',70],
    ['Dossier on Dmitri', 'Receive Vory Intel On Dmitri',70],
    ['Dossier on Dmitri', 'Buy Mafiya Intel On Dmitri',70],
    ['Ballistic Knife', 'Silence A Political Critic',70],
    ['Severnyy Olen Snowbike', 'Extract A Favor From The Winner',70],
    ['Set of Photos of Karpov', 'Kill An Investigative Reporter',70],
    ['Set of Photos of Karpov', 'Catch Karpov Accepting A Bribe',70],
    ['RAS-15', '"Convince" The Candidate To Withdraw',70],
    ['Officer Corps Paycheck', 'Capitalize On An Officer\'s Gambling Problem',70],
    ['Officer Corps Paycheck', 'Intercept The Base\'s Pay Shipment',70],
    ['Bank Guard Uniform', 'Strip A Uniform Off The Corpse',70],
    ['Bank Guard Uniform', '"Borrow" The Guard\'s Uniform After Releasing Him',70],
    ['Stick of Dynamite', 'Sabotage The Plan From The Inside',70],
    ['Stick of Dynamite','Stop The ULF Attack',70],
    ['Mansion Details','Break Into An Architect\'s Office',70],
    ['Mansion Details', 'Threaten A Mafiya Moneyman\'s Family',70]
  );
    ...
    necessaryItems.forEach(
      function(i){
        ...
        requirementJob.forEach(
          function(j){
            if (level >= j[2] && j[0] == i.alt && j[1] != xJob) {
              jobs.push(j[1]);
              items.push(i.alt);
            }
          }
